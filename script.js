  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (type === 'tel' && !isValidPhone(value)) {
        setFieldError(field, field.getAttribute('data-error-tel') || 'Please enter a valid phone number.');
        return false;
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f3661f83-d44e-4434-884c-fa8b4e7b93b3',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f3661f83-d44e-4434-884c-fa8b4e7b93b3';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f3661f83-d44e-4434-884c-fa8b4e7b93b3';
